...
private:
    double side, lenght;
public:
    RectangleCake() : CakeShape(), side(0), lenght(0) {} 
    RectangleCake(double height, double side, double lenght) : CakeShape(height), side(side), lenght(lenght) {}
...
int main() {
   ...
   RectangleCake rectangleCake(1, 2, 5);
